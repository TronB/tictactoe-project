...
/***/ function(module, exports, __webpack_require__) {
	...
	var gameApi = __webpack_require__(12);
	$(function () {
	...
	var gameBoard = [];
	$('#newGame').hide();
	var newGameLoop = function newGameLoop() {
	  $('.game-board td').show();
	...
	$(document).ready(function () {
	  var onClickCell = function onClickCell(evt) {
	    ...
	    var positionOnBoard = $(evt.target).data('id'); // 1 or 2, etc
